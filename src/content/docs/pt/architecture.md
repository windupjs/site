...
| `scan/` | Indexação do projeto. Camada 1: rotas por convenção (Next.js, react-router). Camada 2: elementos interativos via parsing de JSX ciente de chaves (tags cruas + componentes de design-system). Camada 3: LLM-assist limitado, memoizado por hash de arquivo. |
