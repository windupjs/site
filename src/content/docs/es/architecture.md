...
| `scan/` | Indexación del proyecto. Capa 1: rutas por convención (Next.js, react-router). Capa 2: elementos interactivos mediante parsing de JSX consciente de llaves (etiquetas crudas + componentes de design system). Capa 3: asistencia LLM con tope, memoizada por hash de archivo. |
