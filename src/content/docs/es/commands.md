...
| `--fail-on-console` | Falla un escenario si la página registró un error de consola o lanzó una excepción no capturada durante el run (se registra igual; los stubs de `config.network` se excluyen). |
